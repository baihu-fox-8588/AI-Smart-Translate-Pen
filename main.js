...
__export(main_exports, {
  VECTOR_SEARCH_VIEW_TYPE: () => VECTOR_SEARCH_VIEW_TYPE,
  VectorSearchView: () => VectorSearchView,
...
var VECTOR_SEARCH_VIEW_TYPE = "vector-search-view";
var VectorSearchView = class extends import_obsidian.ItemView {
  ...
  async onOpen() {
    ...
    reloadButton.addEventListener("click", async () => {
      ...
      new import_obsidian.Notice("\u5411\u91CF\u8CC7\u6599\u5DF2\u91CD\u65B0\u8F09\u5165");
    });
  }
...
var VectorSearchPlugin = class extends import_obsidian.Plugin {
  constructor() {
    super(...arguments);
    this.vectorData = [];
  ...
  async loadVectorData() {
    try {
      ...
      if (vectorData) {
        this.vectorData = JSON.parse(vectorData);
...
var VectorSearchSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    containerEl.empty();
    new import_obsidian.Setting(containerEl).setName("\u76F8\u4F3C\u5EA6\u95BE\u503C").setDesc("\u8A2D\u5B9A\u641C\u5C0B\u7D50\u679C\u7684\u6700\u5C0F\u76F8\u4F3C\u5EA6\uFF080-1\uFF09").addSlider((slider) => slider.setLimits(0, 1, 0.1).setValue(this.plugin.settings.similarityThreshold).setDynamicTooltip().onChange(async (value) => {
      this.plugin.settings.similarityThreshold = value;
      await this.plugin.saveSettings();
    }));
    new import_obsidian.Setting(containerEl).setName("Gemini API \u91D1\u9470").setDesc("\u8A2D\u5B9A Gemini API \u91D1\u9470").addText((text) => text.setPlaceholder("\u8F38\u5165\u60A8\u7684 API \u91D1\u9470").setValue(this.plugin.settings.apiKey).onChange(async (value) => {
      this.plugin.settings.apiKey = value;
      this.plugin.genAI = new GoogleGenAI({ apiKey: value });
      await this.plugin.saveSettings();
    }));
  }
};
